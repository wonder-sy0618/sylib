...
define(function(require, exports, module) {
	...
	var defaults = {
		...
		apis : {
			...
			"prothird" : "api/open/prothird/{0}",
			"professional" : "api/open/professional/{0}",
			"nation"	: "api/open/nation",
			"provinceall"	: "api/open/provinceall/{0}"
		},
	 ...
	 * 专业
	 */ 
	var prothird = function(callback, prosecondid) {
		apiCaller({
			success : callback
		}, 'prothird', function(url) {
			return url.format(prosecondid);
		});
	};
	 ...
	 * 专业树
	 */ 
	var professional = function(callback, depth) {
		apiCaller({
			success : callback
		}, 'professional', function(url) {
			return url.format(depth);
		});
	};
	 ...
	 * 专业树
	 */ 
	var provinceall = function(callback, depth) {
		apiCaller({
			success : callback
		}, 'provinceall', function(url) {
			return url.format(depth);
		});
	};
